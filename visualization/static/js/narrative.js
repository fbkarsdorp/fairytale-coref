...
// set the scene rectangles to a relative width or a default width
relative_scene_width = false;
...
function Location_(name, id, group) {
	this.name = name;
	this.id = id;
	this.group = group;
	this.group_prt = null;
...
function add_loc_scenes(locs, scenes, links, panel_shift, story_name) {
	for (var i = 0; i < locs.length; i++) {
		scenes[locs[i].id].location = locs[i].name;
	}
}
...
function draw_nodes(scenes, svg, chart_width, chart_height, folder, safe_name) {
    ...
    .enter().append("g")
      ...
      .attr("position", function(d) {return d.x; })
    ...
    function mouseover(d) {
    	// d3.selectAll("rect").data(this).enter().append("svg:rect").append("svg:title").text(function (d) {return d.location});
	} // im.onload
...
function draw_chart(name, safe_name, filename, folder, tie_breaker, center_sort, collapse) {
    d3.json(folder + "/" + filename + ".json", function(j) {
	...
	d3.xml(folder + "/" + filename + ".xml", function(x) {
	    var xchars = read_chars(x);
	    var xlocs = read_locs(x);
	    ...
	    */
	    ...
	    for (var i = 0; i < xlocs.length; i++) {
	    	locs[locs.length] = new Location_(xlocs[i].name, xlocs[i].id, xlocs[i].group);
	    	loc_map[xlocs[i].id] = locs[locs.length-1];
	    }
	    ...
	    // var loc_links = generate_links(locs, char_scenes);
	    // var loc_scenes = add_loc_scenes(locs, char_scenes, loc_links, panel_shift, safe_name);
        ...
        drawGraph(folder + "/" + filename + ".tsv", safe_name, d3.min(scenes, function(d) { return d.x}), d3.max(scenes, function(d) { return d.x;}));
	    ...
	    // console.log(d3.max(scenes, function(d) { return d.x;}))

	}); // d3.xml (read chars)
    }); // d3.json (read scenes)
}

function drawGraph(filename, safe_name, start, end) {
	var margin = {top: 20, right: end, bottom: 20, left: start};
	var width = raw_chart_width - Math.abs(raw_chart_width - margin.right) - start;
...
dir = "data";
files = ["SINVS001", "SINVS002", "SINVS003", "SINVS004", "SINVS005", "SINVS006", "SINVS007", "SINVS008", "SINVS009", "SINVS010", "SINVS011", "SINVS012", "SINVS013", "SINVS014", "SINVS015", "SINVS016", "SINVS017", "SINVS018", "SINVS019", "SINVS020", "SINVS021", "SINVS022", "SINVS023", "SINVS024", "SINVS026", "SINVS027", "SINVS028", "SINVS029", "SINVS030", "SINVS031", "SINVS032", "SINVS033", "SINVS034", "SINVS035", "SINVS036", "SINVS037", "SINVS038", "SINVS039", "SINVS040", "SINVS041", "SINVS042", "SINVS043", "SINVS045", "SINVS046", "SINVS047", "SINVS048", "SINVS050", "SINVS051", "SINVS052", "SINVS053", "SINVS054", "SINVS055", "SINVS056", "SINVS057", "SINVS058", "SINVS059", "SINVS060", "SINVS061", "SINVS062", "SINVS063", "SINVS064", "SINVS065", "SINVS066", "SINVS067", "SINVS069", "SINVS070", "SINVS071", "SINVS072", "SINVS073", "SINVS074", "SINVS075", "SINVS076", "SINVS077", "SINVS078"]
files.forEach(function(x) { 

	draw_chart(x, x, x, dir, true, false, false); 
})
